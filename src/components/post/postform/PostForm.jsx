        ...
        <div className="modal-content postForm">
          <form onSubmit={handleSubmitPost}>
            <div className="modal-header ">
              <h5 className="modal-title postTitle" id="PostModalLabel">
                Create Post
              </h5>
            </div>
            <div className="modal-body">
              {loading ? (
                ...
                <div className="previewpostphoto d-flex">
                  <img src={picture} alt="" className="previewpostphoto" />
                  <button
                    type="button"
              ...
              <div className="mb-2">
                <label htmlFor="caption" className="col-form-label postTitle">
                  Caption :
                </label>
                <textarea
            ...
            <div className="modal-footer">
              ...
              {picture && !loading ? (
                <button className="btn postBtnSubmit" data-bs-dismiss="modal">
                  Submit Post
                </button>
              ) : (
                <button
